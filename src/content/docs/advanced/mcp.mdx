---
title: "MCP Servers"
description: "Extend GitHub Copilot's capabilities by connecting to MCP (Model Context Protocol) servers for enhanced AI-powered development workflows."
order: 2
section: "Advanced"
---
...
Visual Studio supports authentication for remote MCP servers using any OAuth provider, following the MCP authorization specification.
